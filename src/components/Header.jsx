...
const Header = () => {
  ...
  return (
    ...
    <Modal  open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
        <p className='text-3xl font-black text-center'> Welcome Back</p>
        <div className="inputs w-[90%] m-auto h-[350px] ">
                <div className="input_box w-full h-[60px] ">
                        <label>Email</label>
                        <Input placeholder='Enter Your Email' onChange={Email}/>
                </div>
                <div className="input_box w-full h-[60px]  ">
                        <label>Password</label>
                        <Input type='password' placeholder='Enter Your Email' onChange={password}/>
                </div>
                ...
                {/* <button onClick={Google} className= "mt-5 e1cx0oj30 seo-pages-miqn20-Button-AuthButton" type="button">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="seo-pages-60w4ze" role="img" version="1.1">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M6.405 13.9c-.2-.6-.314-1.24-.314-1.9 0-.66.114-1.3.314-1.9V7.51H3.064A9.996 9.996 0 0 0 2 12c0 1.614.386 3.14 1.064 4.49l3.34-2.59Z" fill="#FBBC05"></path>
                        <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
